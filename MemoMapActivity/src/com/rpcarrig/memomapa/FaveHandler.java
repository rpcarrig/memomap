...
public class FaveHandler extends SQLiteOpenHelper {
	

	private static final String CLASS = "DatabaseHandler";
			
	public static final String
		DATABASE_NAME = "memoMapFaveDatabase",
		TABLE_MEMOS	  = "memos",
	...
	private static FaveHandler instance = null;
	private FaveHandler(Context context) {
		super(context, DATABASE_NAME, null, DATABASE_VERSION);
		Log.d(CLASS, "DbHandler (constructor)");
	}
	
	public static FaveHandler getInstance(Context context){
		Log.d(CLASS, "getInstance");
		if(instance == null) instance = new FaveHandler(context);
		return instance;
	}
